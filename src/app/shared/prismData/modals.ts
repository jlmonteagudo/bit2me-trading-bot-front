...
export let modalsTS5 = 
`  <ul class="modals-none">
<li class="ti-modals-group-item ti-modals-group-item-action active">
...
<li class="ti-modals-group-item ti-modals-group-item-action hover:bg-gray-200 dark:hover:bg-light">
...
<li class="ti-modals-group-item ti-modals-group-item-action disabled">
    <a class=" ">
        <div class="flex items-center">
            <div>
